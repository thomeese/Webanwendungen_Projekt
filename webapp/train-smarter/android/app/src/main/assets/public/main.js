...
const routes = [
    ...
    },
    {
        ...
        path: 'analytics',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_services_database_service_ts-src_app_services_exercise-db_service_ts"), __webpack_require__.e("default-src_app_pages_exercise_exercise_module_ts"), __webpack_require__.e("default-node_modules_swiper_angular_fesm2015_swiper_angular_mjs"), __webpack_require__.e("src_app_pages_analytics_analytics_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/analytics/analytics.module */ 2679)).then(m => m.AnalyticsPageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    }, {
        path: 'training-plan',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_pages_training-plan_training-plan-detail_training-plan-detail_page_ts"), __webpack_require__.e("default-src_app_pages_training-plan_training-plan_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/training-plan/training-plan.module */ 2589)).then(m => m.TrainingPlanPageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    },
    {
        path: 'exercise',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_services_database_service_ts-src_app_services_exercise-db_service_ts"), __webpack_require__.e("default-src_app_pages_exercise_exercise_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/exercise/exercise.module */ 1751)).then(m => m.ExercisePageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    },
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_pages_training-plan_training-plan-detail_training-plan-detail_page_ts"), __webpack_require__.e("default-node_modules_swiper_angular_fesm2015_swiper_angular_mjs"), __webpack_require__.e("default-src_app_pages_training-plan_training-plan_module_ts"), __webpack_require__.e("src_app_pages_home_home_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/home/home.module */ 7994)).then(m => m.HomePageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    }, {
        path: 'live-training',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_services_database_service_ts-src_app_services_exercise-db_service_ts"), __webpack_require__.e("src_app_pages_live-training_live-training_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/live-training/live-training.module */ 1879)).then(m => m.LiveTrainingPageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    }, {
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_services_database_service_ts-src_app_services_exercise-db_service_ts"), __webpack_require__.e("default-src_app_pages_exercise_exercise-detail_exercise-detail_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/exercise/exercise-detail/exercise-detail.module */ 4496)).then(m => m.ExerciseDetailPageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    },
    {
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_pages_walk-tracker_walk-tracker-detail_walk-tracker-detail_module_ts"), __webpack_require__.e("src_app_services_database_service_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/walk-tracker/walk-tracker-detail/walk-tracker-detail.module */ 2969)).then(m => m.WalkTrackerDetailPageModule),
        canActivate: [_services_authentication_service__WEBPACK_IMPORTED_MODULE_0__.AuthenticationService]
    }
];
...
/* harmony import */ var _awesome_cordova_plugins_calendar_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @awesome-cordova-plugins/calendar/ngx */ 8731);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.NgModule)({
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__.BrowserModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonicModule.forRoot({ navAnimation: _animations_nav_animation__WEBPACK_IMPORTED_MODULE_3__.pageAnimation }), _app_routing_module__WEBPACK_IMPORTED_MODULE_1__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_12__.HttpClientModule,
            (0,_angular_fire_app__WEBPACK_IMPORTED_MODULE_13__.provideFirebaseApp)(() => {
                const app = (0,_angular_fire_app__WEBPACK_IMPORTED_MODULE_13__.initializeApp)(_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.firebase);
                if (_capacitor_core__WEBPACK_IMPORTED_MODULE_4__.Capacitor.isNativePlatform()) {
                    (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_14__.initializeAuth)(app, {
        ...
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_17__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonicRouteStrategy }, _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_6__.Geolocation, _awesome_cordova_plugins_calendar_ngx__WEBPACK_IMPORTED_MODULE_7__.Calendar],
...
"use strict";
module.exports = "ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #d7d8da);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.md ion-item ion-icon {\n  color: #616e7e;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: #73849a;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade);\n}\n\nion-item.selected {\n  --color: var(--ion-color-primary);\n}\n\nion-app {\n  margin-top: 0;\n  margin-bottom: 0;\n}\n\nion-item.toggle {\n  margin-left: 10px;\n  --inner-padding-start: 0px;\n  --padding-start: 0px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
